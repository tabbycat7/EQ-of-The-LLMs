...
function setupBattleMode() {
    ...
    const battleNewRound = document.getElementById('battle-new-round');
    const battleNewRoundBtn = document.getElementById('battle-new-round-btn');

    startBtn.addEventListener('click', startBattle);
    newBattleBtn.addEventListener('click', startBattle);
    sendBtn.addEventListener('click', sendBattleMessage);
    if (battleNewRoundBtn) {
        battleNewRoundBtn.addEventListener('click', () => {
            if (battleInputSection) battleInputSection.style.display = 'flex';
            document.getElementById('battle-send-btn').disabled = false;
            if (battleNewRound) battleNewRound.style.display = 'none';
...
async function submitVote(winner) {
    try {
        ...
        const battleNewRound = document.getElementById('battle-new-round');
        if (battleNewRound) battleNewRound.style.display = 'block';
